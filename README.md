# vue-manage-system #
基于Vue.js 3.x系列 + Element UI 的博客及后台管理系统。[线上地址]()
...
## 前言 ##
Vue + Element组件库做了个后台管理系统，基本很多组件可以直接引用组件库的，图片裁剪上传、富文本编辑器、图表等这些在后台管理系统中很常见的功能，引用的其他的组件才能完成。从寻找组件，到使用组件的过程中，遇到了很多问题，也积累了宝贵的经验。
...
### element-ui ###
一套基于vue.js3.0的桌面组件库。访问地址：[element](http://element.eleme.io/#/zh-CN/component/layout)
