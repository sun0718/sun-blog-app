<template>
    <div class="post-article">
        ...
        <div class="container">
            ...
            <quill-editor v-if="!switchValue" ref="myTextEditor" v-model="quillCon" @change="onEditorChange($event)" :options="editorOption" ></quill-editor>
